...
//    $Id: exceptions.h 25560 2012-05-29 19:16:36Z bangerth $
//
//    Copyright (C) 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2009, 2010, 2012 by the igatools authors
//
//    This file is subject to QPL and may not be  distributed
//    without copyright and license information. Please refer
//    to the file igatools/doc/license.html for the  text  and
//    further information on this license.
//
//---------------------------------------------------------------------------
#ifndef __iga__exceptions_h
#define __iga__exceptions_h

/**
 * @file
 * Here, the iga exception handling is located.
 */
 ...
 *
 *  @ingroup Exceptions
 *  @author Wolfgang Bangerth, 1997, extensions 1998, modified for igatools 2012
 */
...
/**
 * Exception raised if a Not-a-Number is
 * detected.
 *
 * This exception should be used to
 * catch not a number
...
/**
 * A number is not zero, but zero should
 * be here.
 */
DeclException0(ExcNonZero);
...
/**
 * The object should not have been
 * filled with something before
 * this member function is called.
 */
DeclException0(ExcNonEmptyObject);

/**
 * A pointer is null.
 */
DeclException0(ExcNullPtr);

//            /**
//             * The transformation is not supported by the element-field
//             */
// DeclException1(ExcUnsupportedTransformation,
//              Transformation,
//                << "The transformation of type "<< arg1 << " is not supported.");
 ...
 * in a get function or in a search algorithm
 * there is no object (satisfying a certain criteria)
 * to be returned.
 */
DeclException0(ExcNotFound) ;
...
/**
 * This exception is thrown if
 * an error occurred parsing an XML document.
...
/**
 * This exception is thrown if
 * a waring occurred parsing an XML document.
