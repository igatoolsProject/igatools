...
#ifndef BASIS_TOOLS_H_
#define BASIS_TOOLS_H_
...
/**
 * @brief This namespace contains some useful functions for operations involving Basis,
 * like projections, error computations, etc.
 */
namespace basis_tools
{
#ifdef USE_TRILINOS
/**
