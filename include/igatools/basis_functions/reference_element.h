...
class ReferenceElement : public SpaceElement<ReferenceSpace<dim,range,rank>,dim,0,range,rank>
{
public:
    ...
    using parent_t = SpaceElement<ReferenceSpace<dim,range,rank>,dim,0,range,rank>;
