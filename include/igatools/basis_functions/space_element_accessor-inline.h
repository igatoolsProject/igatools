...
auto
SpaceElementAccessor<DerivedElementAccessor,Space,dim,codim,range,rank>::
evaluate_basis_values_at_points(const std::vector<Points<dim>> &points) const -> ValueTable<Value>
{
...
auto
SpaceElementAccessor<DerivedElementAccessor,Space,dim,codim,range,rank>::
evaluate_basis_gradients_at_points(const std::vector<Points<dim>> &points) const -> ValueTable<Derivative<1> >
{
...
auto
SpaceElementAccessor<DerivedElementAccessor,Space,dim,codim,range,rank>::
evaluate_basis_hessians_at_points(const std::vector<Points<dim>> &points) const -> ValueTable<Derivative<2> >
{
...
evaluate_field_derivatives_at_points(
    ...
    const std::vector<Points<dim>> &points) const ->
...
evaluate_field_values_at_points(
    const std::vector<Real> &local_coefs,
    const std::vector<Points<dim>> &points) const -> ValueVector<Value>
{
...
evaluate_field_gradients_at_points(
    const std::vector<Real> &local_coefs,
    const std::vector<Points<dim>> &points) const -> ValueVector<Derivative<1> >
{
...
evaluate_field_hessians_at_points(
    const std::vector<Real> &local_coefs,
    const std::vector<Points<dim>> &points) const -> ValueVector<Derivative<2> >
{
