 ...
 * It can either be of type int, int, double or std::string.
 * In essence, this structure is the same as
 * <code>boost::variant@<int,int,double,std::string@></code>
 ...
 * <tt>int</tt>, <tt>int</tt>, <tt>double</tt>, <tt>std::string</tt>)
