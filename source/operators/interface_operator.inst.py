...
for space in inst.PhysSpaces_v2:
    f.write( 'template class InterfaceOperator<%s>;\n' %space.name)

for space in inst.PhysSpaces_v2:
    f.write( 'template class ValueJump<%s>;\n' %space.name)
    f.write( 'template class NormalGradientJump<%s>;\n' %space.name)
    f.write( 'template class NormalGradientAverage<%s>;\n' %space.name)
    f.write( 'template class LaplacianAverage<%s>;\n' %space.name)
