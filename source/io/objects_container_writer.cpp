             ...
             XMLElement &xml_elem)
{
  ...
  for_each(valid_ref_space_ptr_types, [&](const auto &ptr_type)
  {
    ...
    for (const auto &id : non_const_ids)
    {
        ...
        const auto bs_space = std::dynamic_pointer_cast<BSplineType>(ref_space);
        const auto nr_space = std::dynamic_pointer_cast<NURBSType>(ref_space);
    ...
    for (const auto &id : const_ids)
    {
        ...
        const auto bs_space = std::dynamic_pointer_cast<const BSplineType>(ref_space);
        const auto nr_space = std::dynamic_pointer_cast<const NURBSType>(ref_space);
                      ...
                      XMLElement &xml_elem)
{
  ...
  for_each(valid_gf_ptr_types, [&](const auto &ptr_type)
  {
    ...
    for (const auto &id : non_const_ids)
    {
        ...
        const auto id_f = std::dynamic_pointer_cast<IdGridFunc>(grid_func);
        const auto li_f = std::dynamic_pointer_cast<LinearGridFunc>(grid_func);
        const auto ct_f = std::dynamic_pointer_cast<ConstantGridFunc>(grid_func);
        const auto ig_f = std::dynamic_pointer_cast<IgGridFunc>(grid_func);
    ...
    for (const auto &id : const_ids)
    {
        ...
        const auto id_f = std::dynamic_pointer_cast<const IdGridFunc>(grid_func);
        const auto li_f = std::dynamic_pointer_cast<const LinearGridFunc>(grid_func);
        const auto ct_f = std::dynamic_pointer_cast<const ConstantGridFunc>(grid_func);
        const auto ig_f = std::dynamic_pointer_cast<const IgGridFunc>(grid_func);
                 ...
                 XMLElement &xml_elem)
{
  ...
  for_each(valid_f_ptr_types, [&](const auto &ptr_type)
  {
    ...
    for (const auto &id : non_const_ids)
    {
        ...
        const auto li_f = std::dynamic_pointer_cast<LinearFunc>(func);
        const auto ct_f = std::dynamic_pointer_cast<ConstantFunc>(func);
        const auto ig_f = std::dynamic_pointer_cast<IgFunc>(func);
    ...
    for (const auto &id : const_ids)
    {
        ...
        const auto li_f = std::dynamic_pointer_cast<const LinearFunc>(func);
        const auto ct_f = std::dynamic_pointer_cast<const ConstantFunc>(func);
        const auto ig_f = std::dynamic_pointer_cast<const IgFunc>(func);
...
void
ObjectsContainerWriter::
write_grid (const std::shared_ptr<Grid> grid,
            XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_spline_space (const std::shared_ptr<SpSpace> spline_space,
                    XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_bspline (const std::shared_ptr<BSpline> bspline,
               XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_nurbs (const std::shared_ptr<NURBS> nurbs,
             XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_identity_grid_function (const std::shared_ptr<IdGridFunc> id_func,
                              XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_constant_grid_function (const std::shared_ptr<ConstGridFunc> const_func,
                              XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_linear_grid_function (const std::shared_ptr<LinearGridFunc> linear_func,
                            XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_ig_grid_function (const std::shared_ptr<IgGridFunc> ig_func,
                        XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_domain (const std::shared_ptr<Domain> domain,
              XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_phys_space_basis (const std::shared_ptr<PhysSpaceBasis> phys_space,
                        XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_ig_function (const std::shared_ptr<IgFunction> ig_function,
                   XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_constant_function (const std::shared_ptr<ConstantFunction> const_function,
                         XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
...
void
ObjectsContainerWriter::
write_linear_function (const std::shared_ptr<LinearFunction> linear_function,
                         XMLElement &xml_elem)
{
    AssertThrow (false, ExcNotImplemented());
}
