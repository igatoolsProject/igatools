...
macro(create_configuration_target)

  # igatools Paraview plugin manager source files
  set (manager_source_files_xml "vtkIgatoolsReader.xml")
  set (manager_source_files_cxx "vtkIgatoolsReader.cpp")

  # igatools Paraview plugin source files
  set (source_dirs "source")
  foreach(dir ${source_dirs})
    file(GLOB source ${PROJECT_SOURCE_DIR}/${dir}/*.cpp)
