 ...
 *  built using an CylindricalAnnulusGridFunction
 *  author: martinelli
 *  date: Jan 12, 2016
 */
...
void test_sub_domain(const int s_id)
{
  ...
  {{1.,1.5,2.},{0.,numbers::PI/4.,numbers::PI/2.},{0.,1.,2.}});
...
int main()
{
  for (int s_id = 0 ; s_id < UnitElement<3>::n_faces ; ++s_id)
  {
    test_sub_domain<2,1>(s_id);
  }
