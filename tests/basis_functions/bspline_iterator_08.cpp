...
void basis_cache_fill_elem(const basis_element::Flags flag,
...
int main()
{
  ...
  basis_cache_fill_elem<1>(basis_element::Flags::value, 2);
  basis_cache_fill_elem<1>(basis_element::Flags::gradient, 2);
  basis_cache_fill_elem<1>(basis_element::Flags::hessian, 2);
  //  basis_cache_fill_elem<2>();
