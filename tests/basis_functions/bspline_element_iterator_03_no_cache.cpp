...
void do_test()
{
    ...
    vector<Points<dim_domain>> eval_points_1 = quad_scheme_1.get_points().get_flat_cartesian_product();
    ...
    vector<Points<dim_domain>> eval_points_2 = quad_scheme_2.get_points().get_flat_cartesian_product();
