...
void uniform_space_cache(const NewValueFlags flag,
...
int main()
{
    ...
    uniform_space_cache<1>(NewValueFlags::value);
    uniform_space_cache<2>(NewValueFlags::value);

    uniform_space_cache<1>(NewValueFlags::gradient);
    return  0;
}
