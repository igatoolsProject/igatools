...
MultiPatchSpace<PhySpace> & do_test(vector<shared_ptr<Mapping<dim,0>>> & maps, vector<int> degrees, LogStream& out){	
...
int main()
{
	...
	auto domain_multip do_test<dim,dim_field>(maps_d21, degrees, out);
